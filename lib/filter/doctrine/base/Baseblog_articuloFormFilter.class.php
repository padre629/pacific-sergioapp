...
/**
 * blog_articulo filter form base class.
 *
 ...
 */
abstract class Baseblog_articuloFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('blog_articulo_filters[%s]');
